...
export const sportQuests = [
    ...
    {
      id: 5,
      title: "Complete a yoga session",
      xpReward: 25,
      type: "Sport",
    },
    {
      id: 6,
      title: "Join a sports competition",
      xpReward: 50,
      type: "Sport",
    },
  ];
  ...
  export const culturalQuests = [
    {
      ...
      xpReward: 10,
      type: "Culture", // نوع المهمة: ثقافية
    },
    {
      id: 8,
      title: "Write a summary of a documentary",
      xpReward: 20,
      type: "Culture",
    },
    {
  ...
  export const generateQuestByLevel = (level) => {
    ...
    // دمج المهام الرياضية والثقافية في قائمة واحدة
    if (level >= 2) {
      return [
        ...sportQuestsToShow,
        ...culturalQuestsToShow,
      ]; // يمكن تغيير التصفية حسب المستوى
    } else {
